      ...
      <>
         <main className="px-9 py-6 bg-[#1A1B21]">
            <div>
               ...
               <p className="text-xs font-extralight p-2">https://riyabulia12.github.io/Portfolio/</p>
            </div>
            <div className="py-2">
               <a href="https://www.linkedin.com/in/riya-bulia" className="bg-[#5093E2] inline-flex rounded justify-center items-center space-x-2 w-full p-3">
