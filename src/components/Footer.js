const Footer = () => {
   return (
      <>
      <footer className="bg-[#161619] py-5 rounded-b-xl">
         <ul className="flex justify-center space-x-9" >
            <li>
               <a href="mailto:riyabulia12@gmail.com" className="transition ease-in-out delay-150 hover:text-[#F3BF99]">
            ...
            <li>
               <a href="https://github.com/RiyaBulia12" className="transition ease-in-out delay-150 hover:text-[#F3BF99]">
            ...
            <li>
               <a href="https://leetcode.com/RiyaBulia" className="transition ease-in-out delay-150 hover:text-[#F3BF99]">
            ...
            <li>
               <a href="https://www.hackerrank.com/RiyaBulia" className="transition ease-in-out delay-150 hover:text-[#F3BF99]">
               <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-5 h-5">
